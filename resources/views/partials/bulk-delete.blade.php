<button class="btn btn-red delete" id="bulk_delete_btn" disabled>{{ __('voyager::generic.bulk_delete') }}</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('voyager.'.$dataType->slug.'.index') }}/0" id="bulk_delete_form" method="POST">
                    ...
                    <input type="submit" class="btn btn-red pull-right delete-confirm"
