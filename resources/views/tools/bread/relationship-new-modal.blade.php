		    ...
		    <div class="model-content">
			        	...
			        	@if(isset($dataType->id))
				            <div class="col-md-12 relationship_details">
				                <p class="relationship_table_select">{{ \Illuminate\Support\Str::singular(ucfirst($table)) }}</p>
				                	...
				                	<input type="text" class="form-control" name="relationship_model" placeholder="{{ __('voyager::database.relationship.namespace') }}" value="{{ $relationshipDetails->model ?? ''}}">
												</div>
											</div>
				            </div>
				                ...
				                <div class="well">
				                    ...
				                    <label>{{ __('voyager::database.relationship.selection_details') }} <span class="label_table_name"></span></label>
				                        ...
				                        <select name="relationship_label" class="rowDrop select2" data-table="{{ $tables[0] }}" data-selected="">
														...
														<div class="form-group select relationship_key">
			    ...
			    <div class="modal-footer">
			    	<div class="relationship-btn-container">
	                    ...
	                    @if(isset($dataType->id))
	                    	<button class="btn btn-red btn-relationship"><i class="voyager-plus"></i> <span>{{ __('voyager::database.relationship.add_new') }}</span></button>
	                	@endif
	                </div>
			    </div>
		    </div>
