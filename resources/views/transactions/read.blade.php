...
@section('page_header')
    <div class="action">
        ...
        @can('delete', $dataTypeContent)
            ...
            @else
                <a href="javascript:;" title="{{ __('voyager::generic.delete') }}" class="btn btn-red btn-danger delete" data-id="{{ $dataTypeContent->getKey() }}" id="delete-{{ $dataTypeContent->getKey() }}">
...
@section('content')
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        @endphp
                        <div class="databox">
                          <h3>{{ $row->getTranslatedAttribute('display_name') }}</h3>
                        <div class="box">
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @else
                                ...
                                @if(is_array($dataTypeContent->{$row->field}))
                                    {!! json_printer($dataTypeContent->{$row->field}['data']) !!}
                                @else
                                  <p>{{ is_array($dataTypeContent->{$row->field}) ?  : $dataTypeContent->{$row->field} }}</p>
                                @endif
                            @endif
                        </div><!-- panel-body -->
                      </div>
