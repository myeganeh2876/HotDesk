    ...
    Route::group(['middleware' => 'admin.user'], function() use ($namespacePrefix){
        ...
        Route::group([
            ...
            Route::get('{id}/move_up', [
                'uses' => $namespacePrefix . 'VoyagerSettingsController@move_up',
                'as' => 'move_up',
            ]);
            Route::get('{id}/move_down', [
                'uses' => $namespacePrefix . 'VoyagerSettingsController@move_down',
                'as' => 'move_down',
            ]);
            Route::put('{id}/delete_value', [
                'uses' => $namespacePrefix . 'VoyagerSettingsController@delete_value',
                'as' => 'delete_value',
            ]);
        });
        ...
        Route::group([
            ...
            Route::post('new_folder', [
                'uses' => $namespacePrefix . 'VoyagerMediaController@new_folder',
                'as' => 'new_folder',
            ]);
            Route::post('delete_file_folder', [
                'uses' => $namespacePrefix . 'VoyagerMediaController@delete',
                'as' => 'delete',
            ]);
            Route::post('move_file', ['uses' => $namespacePrefix . 'VoyagerMediaController@move', 'as' => 'move']);
            Route::post('rename_file', [
                'uses' => $namespacePrefix . 'VoyagerMediaController@rename',
                'as' => 'rename',
            ]);
        ...
        Route::group([
            ...
            Route::get('{table}/create', [
                'uses' => $namespacePrefix . 'VoyagerBreadController@create',
                'as' => 'create',
            ]);
            ...
            Route::post('relationship', [
                'uses' => $namespacePrefix . 'VoyagerBreadController@addRelationship',
                'as' => 'relationship',
            ]);
            Route::get('delete_relationship/{id}', [
                'uses' => $namespacePrefix . 'VoyagerBreadController@deleteRelationship',
        ...
        //personalize menus
        Route::group([
            'prefix' => 'personalizemenus',
        ], function() use ($namespacePrefix){

            Route::post('set', $namespacePrefix . 'personalizemenus@set');
            Route::post('delete', $namespacePrefix . 'personalizemenus@delete');
            Route::post('update', $namespacePrefix . 'personalizemenus@update');
        ...
        Route::group([
            ...
            Route::post('set', $namespacePrefix . 'NoteController@set');
            Route::post('delete', $namespacePrefix . 'NoteController@delete');

        });

        //charge sms
        //Route::post('chargesms', $namespacePrefix . 'TransactionController@chargesms');
        ...
        Route::group([
            ...
            Route::get('/', $namespacePrefix . 'ChartController');

        });

        //message template
        Route::group([
            'prefix' => 'messagetemplate',
        ], function() use ($namespacePrefix){

            Route::post('set', $namespacePrefix . 'MessagetemplateController@set');
            Route::post('delete', $namespacePrefix . 'MessagetemplateController@delete');
        ...
        Route::group([
            ...
            /*support */
            Route::post('sendmessage', $namespacePrefix . 'SupportController@sendmessage');
            Route::post('readmessage', $namespacePrefix . 'SupportController@readmessage');
            Route::get('getmessage', $namespacePrefix . 'SupportController@getmessages');
            Route::post('lockmessage', $namespacePrefix . 'SupportController@lockmessage');
            Route::post('banuser', $namespacePrefix . 'SupportController@banuser');
        ...
        Route::group([
            ...
            Route::get('builder', [
                'uses' => $namespacePrefix . 'VoyagerMetaController@builder',
                'as' => 'builder'
            ]);
            Route::post('order', [
                'uses' => $namespacePrefix . 'VoyagerMetaController@order_item',
                'as' => 'order_item'
            ]);
            ...
            Route::group([
                ...
                Route::delete('{id}', [
                    'uses' => $namespacePrefix . 'VoyagerMetaController@delete_menu',
                    'as' => 'destroy'
                ]);
                Route::post('/', [
                    'uses' => $namespacePrefix . 'VoyagerMetaController@add_item',
                    'as' => 'add'
                ]);
                Route::put('/', [
                    'uses' => $namespacePrefix . 'VoyagerMetaController@update_item',
                    'as' => 'update'
                ]);
            });
        });
