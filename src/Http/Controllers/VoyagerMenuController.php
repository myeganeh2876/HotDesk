...
class VoyagerMenuController extends Controller{
    ...
    public function delete_menu($menu, $id){
        ...
        return redirect()->route('voyager.menus.builder', [$menu])->with([
    ...
    public function add_item(Request $request){
        ...
        return redirect()->route('voyager.menus.builder', [$data['menu_id']])->with([
    ...
    public function update_item(Request $request){
        ...
        return redirect()->route('voyager.menus.builder', [$menuItem->menu_id])->with([
