...
class Translator implements ArrayAccess, JsonSerializable{
    ...
    public function save(){
        ...
        foreach($attributes as $key => $attribute){
            if($attribute['exists']){
                ...
                $translation = VoyagerFacade::model('Translation')->where('table_name', $this->model->getTable())->where('column_name', $key)->where('foreign_key', $this->model->getKey())->where('locale', $this->locale)->first();
            }
    ...
    public function getTranslationModel($key, $locale = null){
        return $this->model->getRelation('translations')->where('column_name', $key)->where('locale', $locale ? $locale : $this->locale)->first();
    }
    ...
    public function createTranslation($key, $value){
        ...
        return $this->model->getRelation('translations')->where('key', $key)->where('locale', $this->locale)->first();
    }
    ...
    public function deleteTranslation($key){
        ...
        VoyagerFacade::model('Translation')->where('table_name', $this->model->getTable())->where('column_name', $key)->where('foreign_key', $this->model->getKey())->where('locale', $locale)->delete();
